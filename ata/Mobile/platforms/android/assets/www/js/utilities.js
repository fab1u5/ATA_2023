...
var PartialCells = {
	Presentation: { headers: ['Executive Summary', 'Novelty', 'Content', 'Finances', 'Deep Dive Topic', 'Demonstr. & Structure', 'Delivery', 'Questions', 'General Impression', 'Miscellaneous'], sortfield: ['ExecutiveSummary', 'Novelty', 'Content', 'Finances', 'DeepDiveTopic', 'DemonstrationAndStructure', 'Delivery', 'Questions', 'GeneralImpression', 'Miscellaneous'] },
...
function pageInitializeTitleOnly(title) {
    ...
    //Standard Menu
    $('#divNavBar').append('<img src="images/ATA.png" title="Formula SAE Italy & Formula Electric Italy 2015"/><label class="white-text" style="vertical-align:top;font-size: x-large;">' + title + '</label>');
...
Body = {
    ...
    footer: function () {
        $("body").append(function () {
            return $('<footer/>').html('<div class="footer-copyright"><div class="container">&copy; 2019 Formula ATA<a class="grey-text text-lighten-4 right" href="http://www.polimatica.it">Powered by Polimatica S.r.l</a></div></div>')
