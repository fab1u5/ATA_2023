...
createStatement_scores_presentation += "miscellaneous DOUBLE, miscellaneousnotes STRING, presentationnotes STRING, FOREIGN KEY (scoreid) REFERENCES TB_Scores(id) ON DELETE CASCADE)";
...
selectStatement_scores_presentation_all += "miscellaneous, miscellaneousnotes, presentationnotes, carid, eventid ";
...
selectStatement_scores_presentation += "miscellaneous, miscellaneousnotes, presentationnotes ";
...
function insertRecord_scores_presentation(eventid, carid, scoreP)
{
	if (isATablet()) {
		...
		scoreP.totalPresentation = scoreP.Total(
			...
			scoreP.totalDelivery, scoreP.totalQuestions, scoreP.totalGeneralImpression, scoreP.miscellaneous
		);
            ...
            db.transaction(function (tx) {
                ...
                tx.executeSql(
                    ...
                    [
						...
						scoreP.miscellaneous, scoreP.miscellaneousNotes, scoreP.presentationNotes
                    ],
                    function (tx, result) { foo(); },
                    function (tx, result) { onError(tx, result); }
                );
        ...
        db.transaction(function (tx) {
            tx.executeSql(
                ...
                [
					...
					scoreP.questions[0], scoreP.questions[1], scoreP.questions[2], scoreP.questions[3], scoreP.questions[4], scoreP.questions[5], scoreP.questions[6], scoreP.questions[7], scoreP.questions[8], scoreP.questions[9], scoreP.questionsNotes,
					scoreP.generalImpression[0], scoreP.generalImpression[1], scoreP.generalImpression[2], scoreP.generalImpressionNotes,
					scoreP.miscellaneous, scoreP.miscellaneousNotes, scoreP.presentationNotes, Number(scoreP.scoreid)
                ],
                function (tx, result) { foo(); },
                function (tx, result) { onError(tx, result); }
            );
