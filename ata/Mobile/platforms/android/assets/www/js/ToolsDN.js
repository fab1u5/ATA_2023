$(document).ready(function () {
    ...
    $('#bDownloadTeams').click(function (event) {
        ...
        $.ajax({
            ...
            url: "http://ems.polimatica.it/ATA/services/ATA_ExportService.asmx/DownloadTeams",
            dataType: "json",
    ...
    $('#bDownloadExaminers').click(function (event) {
        ...
        $.ajax({
            type: "POST",
            contentType: "application/json",
            url: "http://ems.polimatica.it/ATA/services/ATA_ExportService.asmx/DownloadExaminers",
            dataType: "json",
            success: function (response) {
                if (response.hasOwnProperty("d")) { response = response.d; }
    ...
    $('#bDownloadCars').click(function (event) {
        ...
        $.ajax({
            type: "POST",
            contentType: "application/json",
            url: "http://ems.polimatica.it/ATA/services/ATA_ExportService.asmx/DownloadCars",
            dataType: "json",
            success: function (response) {
                if (response.hasOwnProperty("d")) { response = response.d; }
