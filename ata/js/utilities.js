...
Body = {
    ...
    footer: function () {
        $("body").append(function () {
            return $('<footer/>').html('<div class="footer-copyright"><div class="container">&copy; 2023 Formula ATA<a class="grey-text text-lighten-4 right" href="http://www.polimatica.it">Powered by Polimatica S.r.l</a></div></div>')
