...
//createStatement_scores_presentation += "executivesummary0 DOUBLE, executivesummary1 DOUBLE, executivesummary2 DOUBLE, executivesummary3 DOUBLE, executivesummarynotes STRING, ";
//FD 2021.08.02 - ATA 2021 - Modify Stage3 - BEGIN tolta parte novelty3
//createStatement_scores_presentation += "novelty0 DOUBLE, novelty1 DOUBLE, novelty2 DOUBLE, novelty3 DOUBLE, noveltynotes STRING, ";
...
//createStatement_scores_presentation += "finances0 DOUBLE, finances1 DOUBLE, finances2 DOUBLE, finances3 DOUBLE, finances4 DOUBLE, finances5 DOUBLE, finances6 DOUBLE, financesnotes STRING, ";
...
createStatement_scores_presentation += "miscellaneous DOUBLE, miscellaneousnotes STRING, presentationnotes STRING, stage1 DOUBLE, FOREIGN KEY (scoreid) REFERENCES TB_Scores(id) ON DELETE CASCADE)";
...
//FD 2021.08.02 - ATA 2021 - Modify Stage3 - BEGIN tolta parte di executive summary
//createStatementView_scores_partial_presentation += " IFNULL(executivesummary0 + executivesummary1 + executivesummary2 + executivesummary3, 0) executivesummary,";
//FD 2021.08.02 - ATA 2021 - Modify Stage3 - BEGIN tolta parte novelty3
//createStatementView_scores_partial_presentation += " IFNULL(novelty0 + novelty1 + novelty2 + novelty3, 0)  novelty,";
...
//FD 2021.08.02 - ATA 2021 - Modify Stage3 - BEGIN tolta parte Finances2 e Finances4
//createStatementView_scores_partial_presentation += " IFNULL(finances0 + finances1 + finances2 + finances3 + finances4 + finances5 + finances6, 0) finances,";
...
createStatementView_scores_partial_presentation += " IFNULL(demonstrationandstructure0 + demonstrationandstructure1 + demonstrationandstructure2 + demonstrationandstructure3 + demonstrationandstructure4, 0) demonstrationandstructure,";
...
//Event 2019 - Presentation Event has been changed
var selectStatement_scores_presentation_all = "SELECT TB_Scores_Presentation.id, scoreid, ";
//FD 2021.08.02 - ATA 2021 - Modify Stage3 - BEGIN tolta parte di executive summary
//selectStatement_scores_presentation_all += "executivesummary0, executivesummary1, executivesummary2, executivesummary3, executivesummarynotes, ";
//FD 2021.08.02 - ATA 2021 - Modify Stage3 - BEGIN tolta parte novelty3
//selectStatement_scores_presentation_all += "novelty0, novelty1, novelty2, novelty3, noveltynotes, ";
selectStatement_scores_presentation_all += "novelty0, novelty1, novelty2, noveltynotes, ";

//FD 2021.08.02 - ATA 2021 - Modify Stage3 - BEGIN Add Content9
//selectStatement_scores_presentation_all += "content0, content1, content2, content3, content4, content5, content6, content7, content8, contentnotes, ";
selectStatement_scores_presentation_all += "content0, content1, content2, content3, content4, content5, content6, content7, content8, content9, contentnotes, ";

//FD 2021.08.02 - ATA 2021 - Modify Stage3 - BEGIN tolta parte Finances2 e Finances4
//selectStatement_scores_presentation_all += "finances0, finances1, finances2, finances3, finances4, finances5, finances6, financesnotes, ";
selectStatement_scores_presentation_all += "finances0, finances1, finances2, financesnotes, ";

//FD 2021.08.02 - ATA 2021 - Modify Stage3 - Add deepdivetopic4
//selectStatement_scores_presentation_all += "deepdivetopic0, deepdivetopic1, deepdivetopic2, deepdivetopic3, deepdivetopicnotes, ";
selectStatement_scores_presentation_all += "deepdivetopic0, deepdivetopic1, deepdivetopic2, deepdivetopic3, deepdivetopic4, deepdivetopicnotes, ";
//FD 2021.08.02 - ATA 2021 - Modify Stage3 - Add Sezione <DemonstrationAndDelivery>
selectStatement_scores_presentation_all += "demonstrationanddelivery0, demonstrationanddelivery1, demonstrationanddelivery2, demonstrationanddelivery3, demonstrationanddeliver4, demonstrationanddelivery5, deepdivetopicnotes, ";

selectStatement_scores_presentation_all += "demonstrationandstructure0, demonstrationandstructure1, demonstrationandstructure2, demonstrationandstructure3, demonstrationandstructure4, demonstrationandstructurenotes, ";
selectStatement_scores_presentation_all += "delivery0, delivery1, delivery2, delivery3, delivery4, delivery5, delivery6, delivery7, delivery8, deliverynotes, ";
selectStatement_scores_presentation_all += "questions0, questions1, questions2, questions3, questions4, questions5, questions6, questions7, questions8, questions9, questionsnotes, ";
selectStatement_scores_presentation_all += "generalimpression0, generalimpression1, generalimpression2, generalimpressionnotes, ";
//FD 2021.07.27 - ATA 2021  - Add Stage1
selectStatement_scores_presentation_all += "miscellaneous, miscellaneousnotes, presentationnotes, carid, eventid, stage1 ";
...
//FD 2021.08.02 - ATA 2021 - Modify Stage3 - BEGIN tolta parte di executive summary
//selectStatement_scores_presentation += "executivesummary0, executivesummary1, executivesummary2, executivesummary3, executivesummarynotes, ";
//FD 2021.08.02 - ATA 2021 - Modify Stage3 - BEGIN tolta parte novelty3
//selectStatement_scores_presentation += "novelty0, novelty1, novelty2, novelty3, noveltynotes, ";
...
//FD 2021.08.02 - ATA 2021 - Modify Stage3 - BEGIN tolta parte Finances2 e Finances4
//selectStatement_scores_presentation += "finances0, finances1, finances2, finances3, finances4, finances5, finances6, financesnotes, ";
...
selectStatement_scores_presentation += "demonstrationandstructure0, demonstrationandstructure1, demonstrationandstructure2, demonstrationandstructure3, demonstrationandstructure4, demonstrationandstructurenotes, ";
...
//FD 2021.07.27 - ATA 2021  - Add Stage1
selectStatement_scores_presentation += "miscellaneous, miscellaneousnotes, presentationnotes, stage1 ";
...
//FD 2021.08.02 - ATA 2021 - Modify Stage3 - BEGIN tolta parte di executive summary
//updateStatement_scores_presentation += "executivesummary0 = ?, executivesummary1 = ?, executivesummary2 = ?, executivesummary3 = ?, executivesummarynotes = ?, ";
//FD 2021.08.02 - ATA 2021 - Modify Stage3 - BEGIN tolta parte novelty3
//updateStatement_scores_presentation += "novelty0 = ?, novelty1 = ?, novelty2 = ?, novelty3 = ?, noveltynotes = ?, ";
...
//FD 2021.08.02 - ATA 2021 - Modify Stage3 - BEGIN tolta parte Finances2 e Finances4
//updateStatement_scores_presentation += "finances0 = ?, finances1 = ?, finances2 = ?, finances3 = ?, finances4 = ?, finances5 = ?, finances6 = ?, financesnotes = ?, ";
...
//FD 2021.07.27 - ATA 2021  - Add Stage1
//updateStatement_scores_presentation += "miscellaneous = ?, miscellaneousnotes = ?, presentationnotes = ? WHERE scoreid = ?";
updateStatement_scores_presentation += "miscellaneous = ?, miscellaneousnotes = ?, presentationnotes = ?, stage1 = ? WHERE scoreid = ?";
        ...
        db.transaction(function (tx) {
            tx.executeSql(
                ...
                function (tx, result) {
                	...
                	//FD 2021.08.02 - ATA 2021 - Modify Stage3 - BEGIN tolta parte di executive summary
                    //scoreP.totalPresentation = parseFloat(scoreP.totalExecutiveSummary)
					//+ parseFloat(scoreP.totalNovelty)
					//+ parseFloat(scoreP.totalContent)
					//+ parseFloat(scoreP.totalFinances)
					//+ parseFloat(scoreP.totalDeepDiveTopic)
					//+ parseFloat(scoreP.totalDemonstrationAndStructure)
					//+ parseFloat(scoreP.totalDelivery)
					//+ parseFloat(scoreP.totalQuestions)
					//+ parseFloat(scoreP.totalGeneralImpression)
					//+ parseFloat(scoreP.miscellaneous)
                    ////FD 2021.07.27 - ATA 2021  - Add Stage1 - BEGIN
                	//+parseFloat(scoreP.stage1);

                    scoreP.totalPresentation =		parseFloat(scoreP.totalNovelty)
												+	parseFloat(scoreP.totalContent)
												+	parseFloat(scoreP.totalFinances)
												+   parseFloat(scoreP.totalDeepDiveTopic)

												//FD 2021.08.02 - ATA 2021 - Modify Stage3 - Add Sezione <DemonstrationAndDelivery>
												+	parseFloat(scoreP.totalDemonstrationAndDelivery)
...
function insertRecord_scores_presentation(eventid, carid, scoreP)
{
	if (isATablet()) {
		...
		//FD 2021.08.02 - ATA 2021 - Modify Stage3 - Add Sezione <DemonstrationAndDelivery>
		//scoreP.totalPresentation = scoreP.Total(scoreP.totalNovelty, scoreP.totalContent, scoreP.totalFinances, scoreP.totalDeepDiveTopic,
		//										scoreP.totalDemonstrationAndStructure, scoreP.totalDelivery, scoreP.totalQuestions, scoreP.totalGeneralImpression,
		//										scoreP.miscellaneous, scoreP.stage1, scoreP.totalDemonstrationAndDelivery);
		//FD 2021.08.02 - ATA 2021 - Modify Stage3 - Remove Sezione <DemonstrationAndStructure>
		
		scoreP.totalPresentation = scoreP.Total(scoreP.totalNovelty, scoreP.totalContent, scoreP.totalFinances, scoreP.totalDeepDiveTopic, scoreP.totalDelivery, scoreP.totalQuestions, scoreP.totalGeneralImpression, scoreP.miscellaneous, scoreP.stage1, scoreP.totalDemonstrationAndDelivery);
		...
		if (Number(scoreP.scoreid) == -1) {
            db.transaction(function (tx) {
            	...
            	//FD 2021.08.02 - ATA 2021 - Modify Stage3 - BEGIN tolta parte novelty3
                //SqlString += "novelty0, novelty1, novelty2, novelty3, noveltynotes, ";
            	...
            	//FD 2021.08.02 - ATA 2021 - Modify Stage3 - BEGIN tolta parte Finances2 e Finances4
                //SqlString += "finances0, finances1, finances2, finances3, finances4, finances5, finances6, financesnotes, ";
                ...
                SqlString += "presentationnotes, stage1) ";

                SqlString += "VALUES( ";
                SqlString += "(SELECT MAX(id) FROM TB_Scores), ";
            	//FD 2021.08.02 - ATA 2021 - Modify Stage3 - BEGIN tolta parte di executive summary
            	//SqlString += "?, ?, ?, ?, ?, ";						//executivesummary
            	//FD 2021.08.02 - ATA 2021 - Modify Stage3 - BEGIN tolta parte novelty3
                //SqlString += "?, ?, ?, ?, ?, ";
                SqlString += "?, ?, ?, ?, ";							//novelty
            	...
            	//FD 2021.08.02 - ATA 2021 - Modify Stage3 - Add deepdivetopic4
            	//SqlString += "?, ?, ?, ?, ?, ";						//deepdivetopic
                SqlString += "?, ?, ?, ?, ?, ?, ";						//deepdivetopic

            	//FD 2021.08.02 - ATA 2021 - Modify Stage3 - Add Sezione <DemonstrationAndDelivery>
                SqlString += "?, ?, ?, ?, ?, ?, ?, ";					//DemonstrationAndDeliver

                SqlString += "?, ?, ?, ?, ?, ?, ";						//demonstrationandstructure
                SqlString += "?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ";			//delivery
                SqlString += "?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ";		//questions
                SqlString += "?, ?, ?, ?, ";							//generalimpression0
                SqlString += "?, ?, ";									//miscellaneous
                //FD 2021.07.27 - ATA 2021  - Add Stage1
                //SqlString += "? )";
                SqlString += "?, ? )";									//presentationnotes, stage1

                console.log("insertRecord_scores_presentation - tablet " + SqlString);	//DEBUG))
                ...
                //    SqlString,
                //    [
				//		scoreP.executiveSummary[0], scoreP.executiveSummary[1], scoreP.executiveSummary[2], scoreP.executiveSummary[3], scoreP.executiveSummaryNotes,
				//		scoreP.novelty[0], scoreP.novelty[1], scoreP.novelty[2], scoreP.novelty[3], scoreP.noveltyNotes,
				...
				//		scoreP.finances[0], scoreP.finances[1], scoreP.finances[2], scoreP.finances[3], scoreP.finances[4], scoreP.finances[5], scoreP.finances[6], scoreP.financesNotes,
				...
				//		scoreP.miscellaneous, scoreP.miscellaneousNotes, scoreP.presentationNotes, scoreP.stage1
                //    ],
                //    function (tx, result) { foo(); },
                //    function (tx, result) { onError(tx, result); }
            	//);
...
function updateRecord_scores_presentation(scoreP)
{
	if (isATablet()) {
		...
		//FD 2021.08.02 - ATA 2021 - Modify Stage3 - Add Sezione <DemonstrationAndDelivery>
    	scoreP.totalDemonstrationAndDelivery	= scoreP.Total(scoreP.demonstrationanddelivery);
		...
		//FD 2021.08.02 - ATA 2021 - Modify Stage3 - Remove Sezione <DemonstrationAndStructure>
		//scoreP.totalPresentation = scoreP.Total(scoreP.totalNovelty, scoreP.totalContent, scoreP.totalFinances, scoreP.totalDeepDiveTopic, scoreP.totalDemonstrationAndStructure, scoreP.totalDelivery, scoreP.totalQuestions, scoreP.totalGeneralImpression, scoreP.miscellaneous, scoreP.stage1);
		scoreP.totalPresentation = scoreP.Total(scoreP.totalNovelty, scoreP.totalContent, scoreP.totalFinances, scoreP.totalDeepDiveTopic, scoreP.totalDelivery, scoreP.totalQuestions, scoreP.totalGeneralImpression, scoreP.miscellaneous, scoreP.stage1);
		...
		db.transaction(function (tx) {
			...
			//				  scoreP.questions[0], scoreP.questions[1], scoreP.questions[2], scoreP.questions[3], scoreP.questions[4], scoreP.questions[5], scoreP.questions[6], scoreP.questions[7], scoreP.questions[8], scoreP.questions[9], scoreP.questionsNotes,
			//				  scoreP.generalImpression[0], scoreP.generalImpression[1], scoreP.generalImpression[2], scoreP.generalImpressionNotes,
			//				  scoreP.miscellaneous, scoreP.miscellaneousNotes, scoreP.presentationNotes, scoreP.stage1, Number(scoreP.scoreid)
			//			  ],
			//			  function (tx, result) { foo(); },
			//			  function (tx, result) { onError(tx, result); }
			//		  );
