$(document).ready(function () {
    ...
    function sendExcelDynamicPenalties() {
        ...
        $.ajax({
            ...
            url: "services/ATA_ImportService.asmx/DynamicPenaltiesUpload",
            data: theString,
            dataType: "json",
    ...
    function sendExcelCost() {
        ...
        $.ajax({
            type: "POST",
            contentType: "application/json",
            url: "services/ATA_ImportService.asmx/CostUpload",
            data: theString,
            dataType: "json",
            success: function (response) {
                if (response.hasOwnProperty("d")) { response = response.d; }
    ...
    function sendExcelTiming() {
        ...
        $.ajax({
            type: "POST",
            contentType: "application/json",
            url: "services/ATA_ImportService.asmx/TimingUpload",
            data: theString,
            dataType: "json",
            success: function (response) {
                if (response.hasOwnProperty("d")) { response = response.d; }
    ...
    function sendExcelFuelConsumption() {
        ...
        $.ajax({
            type: "POST",
            contentType: "application/json",
            url: "services/ATA_ImportService.asmx/FuelConsumptionUpload",
            data: theString,
            dataType: "json",
            success: function (response) {
                if (response.hasOwnProperty("d")) { response = response.d; }
