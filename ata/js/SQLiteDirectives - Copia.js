...
//FD 2021.08.02 - ATA 2021 - Adding Stage2 - Add Section <Stage2> - BEGIN
insertStatement_scores_presentation += "?, ?, ?, ?, ?, ?";					//St2BusinnesFigures
insertStatement_scores_presentation += "?, ?, ?, ?, ?, ?";					//st2Content
insertStatement_scores_presentation += "?, ?, ?, ?, ?, ?";					//st2demonstrationanddelivery
insertStatement_scores_presentation += "?, ?, ?, ?, ? ";					//st2investitors
//FD 2021.08.02 - ATA 2021 - Adding Stage2 - Add Section <Stage2> - END
...
updateStatement_scores_presentation += " presentationnotes = ?, stage1 = ?, ";
                ...
                function (tx, result) {
                    ...
                    if (dataset_scores_presentation.length) {
                        ...
                        $.each(scoreP.st2Content, function (index, value) {
                        	scoreP.st2Content[index] = item['st2businnesfigures' + index];
                        });
                        scoreP.st2ContentNotes = item['st2businnesfiguresnotes'];

                        $.each(scoreP.st2Content, function (index, value) {
                        	scoreP.st2Content[index] = item['st2business' + index];
                        });
                        ...
                        $.each(scoreP.questions, function (index, value) {
                        	scoreP.questions[index] = item['st2investitors' + index];
                        });
                        scoreP.questionsNotes = item['st2investitorsnotes'];
                    	//FD 2021.08.02 - ATA 2021 - Adding Stage2 - Add Section <Stage2> - END
                    ...
                    $("#totalSt2BusinessFiguresBadge").html(scoreP.totalSt2BusinnesFigures);
                    $('#totalSt2BusinessFiguresNotes').val(scoreP.St2BusinnesFiguresNotes);
                    ...
                    $("#totalDemonstrationAndDeliveryBadge").html(scoreP.totalSt2DemonstrationAndDelivery);
                    $('#st2demonstrationAndDeliveryNotes').val(scoreP.st2demonstrationanddeliverynotes);

                	//INVESTITORS
                    $.each(scoreP.st2investitor, function (index, value) {
                    ...
                    $('#totalSt2InvestitorsNotes').val(scoreP.St2InvestitorsNotes);
                	//FD 2021.08.02 - ATA 2021 - Adding Stage2 - Add Section <Stage2> - END
                	...
                	//FD 2021.08.02 - ATA 2021 - Adding Stage2 - Add Section <Stage2> - BEGIN
                    scoreP.totalPresentation += Number(parseFloat(scoreP.st2BusinnesFigures))				? parseFloat(scoreP.st2BusinnesFigures)					: 0;
                    scoreP.totalPresentation += Number(parseFloat(scoreP.st2Content))						? parseFloat(scoreP.st2Content)							: 0;
                    scoreP.totalPresentation += Number(parseFloat(scoreP.st2DemonstrationAndDelivery))		? parseFloat(scoreP.st2DemonstrationAndDelivery)		: 0;
                    scoreP.totalPresentation += Number(parseFloat(scoreP.st2Investitors))					? parseFloat(scoreP.st2Investitors)						: 0;
                	//FD 2021.08.02 - ATA 2021 - Adding Stage2 - Add Section <Stage2> - END
...
function insertRecord_scores_presentation(eventid, carid, scoreP)
{
	if (isATablet()) {
		...
		scoreP.totalPresentation = scoreP.Total(scoreP.stage1, scoreP.totalNovelty, scoreP.totalContent, scoreP.totalFinances, scoreP.totalDeepDiveTopic, scoreP.totalDemonstrationAndDelivery,
												scoreP.totalDelivery, scoreP.totalQuestions, scoreP.totalGeneralImpression, scoreP.miscellaneous,
												scoreP.st2BusinnesFigures, scoreP.st2Content, scoreP.st2DemonstrationAndDelivery, scoreP.st2Investitors);
		...
		if (Number(scoreP.scoreid) == -1) {
			db.transaction(function (tx) {
            	...
            	//FD 2021.08.02 - ATA 2021 - Modify Stage3 - BEGIN Add Content9
            	SqlString += "?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?,";										//content - 11

            	//FD 2021.08.02 - ATA 2021 - Modify Stage3 - BEGIN tolta parte Finances2 e Finances4
            	SqlString += "?, ?, ?, ?, ";															//finances - 4

            	//FD 2021.08.02 - ATA 2021 - Modify Stage3 - Add deepdivetopic4
            	SqlString += "?, ?, ?, ?, ?, ?, ";														//deepdivetopic - 6

            	//FD 2021.08.02 - ATA 2021 - Modify Stage3 - Add Sezione <DemonstrationAndDelivery>
            	SqlString += "?, ?, ?, ?, ?, ?, ?, ";													//DemonstrationAndDelivery - 7
				...
				//FD 2021.08.02 - ATA 2021 - Adding Stage2 - Add Section <Stage2> - BEGIN
            	SqlString += "?, ?, ?, ?, ?, ?, ";														//St2BusinnesFigures - 6
            	SqlString += "?, ?, ?, ?, ?, ?, ";														//St2Content - 6
            	SqlString += "?, ?, ?, ?, ?, ?, ";														//St2DemonstrationAndDeliveryNotes - 6
            	SqlString += "?, ?, ?, ?, ?, ";															//St2Investitors - 5
				//FD 2021.08.02 - ATA 2021 - Adding Stage2 - Add Section <Stage2> - END

            	//FD 2021.07.27 - ATA 2021  - Add Stage1
            	SqlString += "?, ? )";																	//presentationnotes, stage1 - 2
...
function updateRecord_scores_presentation(scoreP)
{
	if (isATablet()) {
		...
		//FD 2021.08.02 - ATA 2021 - Modify Stage3 - Remove Sezione <DemonstrationAndStructure>
    	scoreP.totalDemonstrationAndStructure	= 0;//scoreP.Total(scoreP.demonstrationAndStructure);
    	...
    	scoreP.totalSt2DemonstrationAndDelivery = scoreP.Total(scoreP.st2DemonstrationAndDelivery);
    	scoreP.totalSt2Investitors				= scoreP.Total(scoreP.st2Investitors);
		//FD 2021.08.02 - ATA 2021 - Adding Stage2 - Add Section <Stage2> _ END
