...
function WS_loadExamBoards() {
    $.ajax({
        ...
        url: "services/ATA_WebService.asmx/GetExamBoards",
        data: "",
        dataType: "json",
...
function WS_showRecords_examboards_events(preselectedValue) {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json",
        url: "services/ATA_WebService.asmx/GetEvents",
        data: "",
        dataType: "json",
        success: function (response) {
            if (response.hasOwnProperty("d")) { response = response.d; }
...
function WS_loadExamBoardsWithCars() {
    $.ajax({
        type: "POST",
        contentType: "application/json",
        url: "services/ATA_WebService.asmx/GetExamBoardsWithCars",
        data: "",
        dataType: "json",
        success: function (response) {
            if (response.hasOwnProperty("d")) { response = response.d; }
...
function WS_loadExamBoardsWithExaminers() {
    $.ajax({
        type: "POST",
        contentType: "application/json",
        url: "services/ATA_WebService.asmx/GetExamBoardsWithExaminers",
        //url: "https://anfia-atabeta.training4u.it/services/ATA_WebService.asmx/GetExamBoardsWithExaminers",
        data: "",
        dataType: "json",
        success: function (response) {
            if (response.hasOwnProperty("d")) { response = response.d; }
...
function WS_insertRecords_fuels(name) {
    ...
    //    type: "POST",
    //    contentType: "application/json", 
    //    url: "services/ATA_WebService.asmx/InsertFuel",
    //    data: theString,
    //    dataType: "json",
    //    success: function (response) {
    //        if (response.hasOwnProperty("d")) { response = response.d; }
...
function WS_insertRecords_classes(name) {
    ...
    //    type: "POST",
    //    contentType: "application/json",
    //    url: "services/ATA_WebService.asmx/InsertClass",
    //    data: theString,
    //    dataType: "json",
    //    success: function (response) {
    //        if (response.hasOwnProperty("d")) { response = response.d; }
...
function WS_insertRecord_cars(carno, regno, teamid, classid, fuelid, deliverydocdate, boxno) {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json",
        url: "services/ATA_WebService.asmx/InsertCar",
        data: theString,
        dataType: "json",
        success: function (response) {
            if (response.hasOwnProperty("d")) { response = response.d; }
...
function WS_deleteRecord_cars(id) {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json",
        url: "services/ATA_WebService.asmx/DeleteCar",
        data: theString,
        dataType: "json",
        success: function (response) {
            if (response.hasOwnProperty("d")) { response = response.d; }
...
function WS_updateRecord_cars(id, carno, regno, teamid, classid, fuelid, deliverydocdate, boxno) {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json",
        url: "services/ATA_WebService.asmx/UpdateCar",
        data: theString,
        dataType: "json",
        success: function (response) {
            if (response.hasOwnProperty("d")) { response = response.d; }
...
function WS_updateRecord_cars_scores(id, fuelid, deliverydocdate, boxno) {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json",
        url: "services/ATA_WebService.asmx/UpdateCarFromScores",
        data: theString,
        dataType: "json",
        success: function (response) {
            if (response.hasOwnProperty("d")) { response = response.d; }
...
function WS_showRecords_cars() {
    $.ajax({
        type: "POST",
        contentType: "application/json",
        url: "services/ATA_WebService.asmx/GetCars",
        data: "",
        dataType: "json",
        success: function (response) {
            if (response.hasOwnProperty("d")) { response = response.d; }
...
function WS_showRecords_cars_byfilters(carno, regno, teamid, classid, fuelid, deliverydocdate, boxno) {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json",
        url: "services/ATA_WebService.asmx/GetCarsByFilters",
        data: theString,
        dataType: "json",
        success: function (response) {
            if (response.hasOwnProperty("d")) { response = response.d; }
...
function WS_showRecords_cars_classes(ooId) {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json",
        url: "services/ATA_WebService.asmx/GetClasses",
        data: "",
        dataType: "json",
        success: function (response) {
            if (response.hasOwnProperty("d")) { response = response.d; }
...
function WS_showRecords_cars_fuels(ooId) {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json",
        url: "services/ATA_WebService.asmx/GetFuels",
        data: "",
        dataType: "json",
        success: function (response) {
            if (response.hasOwnProperty("d")) { response = response.d; }
...
function WS_showRecords_cars_teams(ooId) {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json",
        url: "services/ATA_WebService.asmx/GetTeams",
        data: "",
        dataType: "json",
        success: function (response) {
            if (response.hasOwnProperty("d")) { response = response.d; }
...
function WS_insertRecord_teams(teamname, university, country) {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json",
        url: "services/ATA_WebService.asmx/InsertTeam",
        data: theString,
        dataType: "json",
        success: function (response) {
            if (response.hasOwnProperty("d")) { response = response.d; }
...
function WS_deleteRecord_teams(id) {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json",
        url: "services/ATA_WebService.asmx/DeleteTeam",
        data: theString,
        dataType: "json",
        success: function (response) {
            if (response.hasOwnProperty("d")) { response = response.d; }
...
function WS_updateRecord_teams(id, teamname, university, country) {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json",
        url: "services/ATA_WebService.asmx/UpdateTeam",
        data: theString,
        dataType: "json",
        success: function (response) {
            if (response.hasOwnProperty("d")) { response = response.d; }
...
function WS_insertRecord_examiners(firstname, surname, phone) {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json",
        url: "services/ATA_WebService.asmx/InsertExaminer",
        data: theString,
        dataType: "json",
        success: function (response) {
            if (response.hasOwnProperty("d")) { response = response.d; }
...
function WS_deleteRecord_examiners(id) {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json",
        url: "services/ATA_WebService.asmx/DeleteExaminer",
        data: theString,
        dataType: "json",
        success: function (response) {
            if (response.hasOwnProperty("d")) { response = response.d; }
...
function WS_updateRecord_examiners(id, firstname, surname, phone) {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json",
        url: "services/ATA_WebService.asmx/UpdateExaminer",
        data: theString,
        dataType: "json",
        success: function (response) {
            if (response.hasOwnProperty("d")) { response = response.d; }
...
function WS_showRecords_examiners() {
    $.ajax({
        type: "POST",
        contentType: "application/json",
        url: "services/ATA_WebService.asmx/GetExaminers",
        data: "",
        dataType: "json",
        success: function (response) {
            if (response.hasOwnProperty("d")) { response = response.d; }
...
function WS_insertRecord_examboards(examboardname, description, usecolor, color, eventid) {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json",
        url: "services/ATA_WebService.asmx/InsertExamBoard",
        data: theString,
        dataType: "json",
        success: function (response) {
            if (response.hasOwnProperty("d")) { response = response.d; }
...
function WS_deleteRecord_examboards(id) {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json",
        url: "services/ATA_WebService.asmx/DeleteExamBoard",
        data: theString,
        dataType: "json",
        success: function (response) {
            if (response.hasOwnProperty("d")) { response = response.d; }
...
function WS_updateRecord_examboards(id, examboardname, description, usecolor, color, eventid) {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json",
        url: "services/ATA_WebService.asmx/UpdateExamBoard",
        data: theString,
        dataType: "json",
        success: function (response) {
            if (response.hasOwnProperty("d")) { response = response.d; }
...
function WS_insertRecord_examboards2examiners(examboardid, examinerid) {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json",
        url: "services/ATA_WebService.asmx/InsertExamBoardExaminer",
        data: theString,
        dataType: "json",
        success: function (response) {
            if (response.hasOwnProperty("d")) { response = response.d; }
...
function WS_deleteRecord_examboards2examiners(examboardid, examinerid) {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json",
        url: "services/ATA_WebService.asmx/DeleteExamBoardExaminer",
        data: theString,
        dataType: "json",
        success: function (response) {
            if (response.hasOwnProperty("d")) { response = response.d; }
...
function WS_showRecords_examboards2examiners(id) {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json",
        url: "services/ATA_WebService.asmx/GetExamBoardExaminersAssignable",
        data: theString,
        dataType: "json",
        success: function (response) {
            if (response.hasOwnProperty("d")) { response = response.d; }
...
function WS_insertRecord_examboards2cars(examboardid, carid) {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json",
        url: "services/ATA_WebService.asmx/InsertExamBoardCar",
        data: theString,
        dataType: "json",
        success: function (response) {
            if (response.hasOwnProperty("d")) { response = response.d; }
...
function WS_deleteRecord_examboards2cars(examboardid, carid) {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json",
        url: "services/ATA_WebService.asmx/DeleteExamBoardCar",
        data: theString,
        dataType: "json",
        success: function (response) {
            if (response.hasOwnProperty("d")) { response = response.d; }
...
function WS_showRecords_examboards2cars(id) {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json",
        url: "services/ATA_WebService.asmx/GetExamBoardCarsAssignable",
        data: theString,
        dataType: "json",
        success: function (response) {
            if (response.hasOwnProperty("d")) { response = response.d; }
...
function WS_insertRecords_eventstypes(name) {
    ...
    //    type: "POST",
    //    contentType: "application/json", 
    //    url: "services/ATA_WebService.asmx/InsertEventType",
    //    data: theString,
    //    dataType: "json",
    //    success: function (response) {
    //        if (response.hasOwnProperty("d")) { response = response.d; }
...
function WS_insertRecords_eventsnames(name, eventTypeId) {
    ...
    //    type: "POST",
    //    contentType: "application/json", 
    //    url: "services/ATA_WebService.asmx/InsertEventName",
    //    data: theString,
    //    dataType: "json",
    //    success: function (response) {
    //        if (response.hasOwnProperty("d")) { response = response.d; }
...
function WS_insertRecord_events(eventTypeId, eventNameId, description, isScoreNumeric, maximumscore) {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json",
        url: "services/ATA_WebService.asmx/InsertEvent",
        data: theString,
        dataType: "json",
        success: function (response) {
            if (response.hasOwnProperty("d")) { response = response.d; }
...
function WS_deleteRecord_events(id) {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json",
        url: "services/ATA_WebService.asmx/DeleteEvent",
        data: theString,
        dataType: "json",
        success: function (response) {
            if (response.hasOwnProperty("d")) { response = response.d; }
...
function WS_updateRecord_events(id, eventTypeId, eventNameId, description, isScoreNumeric, maximumscore) {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json",
        url: "services/ATA_WebService.asmx/UpdateEvent",
        data: theString,
        dataType: "json",
        success: function (response) {
            if (response.hasOwnProperty("d")) { response = response.d; }
...
function WS_showRecords_events_eventstypes(id) {
    $.ajax({
        type: "POST",
        contentType: "application/json",
        url: "services/ATA_WebService.asmx/GetEventsTypes",
        data: "",
        dataType: "json",
        success: function (response) {
            if (response.hasOwnProperty("d")) { response = response.d; }
...
function WS_showRecords_events_eventsnames(id, preselectedValue) {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json",
        url: "services/ATA_WebService.asmx/GetEventNameByEventTypeId",
        data: theString,
        dataType: "json",
        success: function (response) {
            if (response.hasOwnProperty("d")) { response = response.d; }
...
function WS_showRecords_eventsResults(id, classId) {
    ...
    if (id != 0) {
        ...
        $.ajax({
            type: "POST",
            contentType: "application/json",
            url: "services/ATA_WebService.asmx/GetOverallRanking",
            data: theString,
            dataType: "json",
            success: function (response) {
                if (response.hasOwnProperty("d")) { response = response.d; }
    ...
    switch (id) {
        case TypeOfEventByName.Presentation.value:
            $.ajax({
                type: "POST",
                contentType: "application/json",
                url: "services/ATA_WebService.asmx/CalculateScorePresentation",
                data: theString,
                dataType: "json",
                success: function (response) {
                    if (response.hasOwnProperty("d")) { response = response.d; }
        ...
        case TypeOfEventByName.Cost.value:
            $.ajax({
                type: "POST",
                contentType: "application/json",
                url: "services/ATA_WebService.asmx/CalculateScoreCost2015",
                data: theString,
                dataType: "json",
                success: function (response) {
                    if (response.hasOwnProperty("d")) { response = response.d; }
        ...
        case TypeOfEventByName.Design.value:
            $.ajax({
                type: "POST",
                contentType: "application/json",
                url: "services/ATA_WebService.asmx/CalculateDesignScore",
                data: theString,
                dataType: "json",
                success: function (response) {
                    if (response.hasOwnProperty("d")) { response = response.d; }
        ...
        case TypeOfEventByName.Acceleration.value:
            $.ajax({
                type: "POST",
                contentType: "application/json",
                url: "services/ATA_WebService.asmx/CalculateScoreAcceleration",
                data: theString,
                dataType: "json",
                success: function (response) {
                    if (response.hasOwnProperty("d")) { response = response.d; }
        ...
        case TypeOfEventByName.SkidPad.value:
            $.ajax({
                type: "POST",
                contentType: "application/json",
                url: "services/ATA_WebService.asmx/CalculateScoreSkidPad",
                data: theString,
                dataType: "json",
                success: function (response) {
                    if (response.hasOwnProperty("d")) { response = response.d; }
        ...
        case TypeOfEventByName.Autocross.value:
            $.ajax({
                type: "POST",
                contentType: "application/json",
                url: "services/ATA_WebService.asmx/CalculateScoreAutocross",
                data: theString,
                dataType: "json",
                success: function (response) {
                    if (response.hasOwnProperty("d")) { response = response.d; }
        ...
        case TypeOfEventByName.Endurance.value:
            $.ajax({
                type: "POST",
                contentType: "application/json",
                url: "services/ATA_WebService.asmx/CalculateScoreEndurance",
                data: theString,
                dataType: "json",
                success: function (response) {
                    if (response.hasOwnProperty("d")) { response = response.d; }
...
function WS_showRecords_scores_cars_classes(preselectedClass) {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json",
        url: "services/ATA_WebService.asmx/GetScoresClassesEvents",
        data: "",
        dataType: "json",
        success: function (response) {
            if (response.hasOwnProperty("d")) { response = response.d; }
...
function WS_showRecords_scores(classid, eventid) {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json",
        url: "services/ATA_WebService.asmx/GetScoresByClassAndEvent",
        data: theString,
        dataType: "json",
        success: function (response) {
            if (response.hasOwnProperty("d")) { response = response.d; }
            ...
            for (var i = 0; i < dataset_scores_bycar.length; i++) {
                ...
                //console.log("FDT - EVENTO id: " + eventid);
                if (eventid == 7) {
                ...
                //FDT - ATA 2024: se l'avento è presentation metto due celle nascoste 
                //altrimenti l'ordinamento non funziona (sono le colonne di Efficency e Endurance definite nel ScoresByCar.html) 
                if (eventid == 6) {
                    text2Append += '<td style="display: none;" ></td>';
                    text2Append += '<td style="display: none;" ></td>';
                }
...
function WS_insertMultipleRecord_scores(multipleScores2Insert) {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json",
        url: "services/ATA_WebService.asmx/InsertScoresOneShot",
        data: theString,
        dataType: "json",
        success: function (response) {
            if (response.hasOwnProperty("d")) { response = response.d; }
...
function WS_insertRecord_scores(eventid, carid, score, penalityscore, penalitynotes, correctedscore) {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json",
        url: "services/ATA_WebService.asmx/InsertScore",
        data: theString,
        dataType: "json",
        success: function (response) {
            if (response.hasOwnProperty("d")) { response = response.d; }
...
function WS_deleteRecord_scores(eventid, carid) {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json",
        url: "services/ATA_WebService.asmx/DeleteScoresOneShot",
        data: theString,
        dataType: "json",
        success: function (response) {
            if (response.hasOwnProperty("d")) { response = response.d; }
...
function WS_updateRecord_scores(eventid, carid, score, penalityscore, penalitynotes, correctedscore) {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json",
        url: "services/ATA_WebService.asmx/UpdateScore",
        data: theString,
        dataType: "json",
        success: function (response) {
            if (response.hasOwnProperty("d")) { response = response.d; }
...
function WS_updateRecord_scores_score(id, score) {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json",
        url: "services/ATA_WebService.asmx/UpdateScoreGivenScore",
        data: theString,
        dataType: "json",
        success: function (response) {
            if (response.hasOwnProperty("d")) { response = response.d; }
...
function WS_showRecords_scores_eventdetails(classid, eventid) {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json",
        url: "services/ATA_WebService.asmx/GetScoreEventDetail",
        data: theString,
        dataType: "json",
        success: function (response) {
            if (response.hasOwnProperty("d")) { response = response.d; }
...
function WS_configuration_download(examboardid) {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json",
        url: "services/ATA_ExportService.asmx/ConfigurationDownload",
        data: theString,
        dataType: "json",
        success: function (response) {
            if (response.hasOwnProperty("d")) { response = response.d; }
...
function WS_insertRecord_scores_design1E(eventid, carid, scoreid, suspension, framebodyaero, tractivedriverecoverysystem, cockpitcontrolsbrakessafety, systemmanagementintegration, manufacturabilityserviceability, aestheticsstyle, creativity, carweight, overall, suspensionnotes, framebodyaeronotes, tractivedriverecoverysystemnotes, cockpitcontrolsbrakessafetynotes, systemmanagementintegrationnotes, manufacturabilityserviceabilitynotes, aestheticsstylenotes, creativitynotes, miscellaneous, miscellaneousnotes) {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json",
        url: "services/ATA_WebService.asmx/InsertScoreDesign1E",
        data: theString,
        dataType: "json",
        success: function (response) {
            if (response.hasOwnProperty("d")) { response = response.d; }
...
function WS_updateRecord_scores_design1E(scoreid, suspension, framebodyaero, tractivedriverecoverysystem, cockpitcontrolsbrakessafety, systemmanagementintegration, manufacturabilityserviceability, aestheticsstyle, creativity, carweight, overall, suspensionnotes, framebodyaeronotes, tractivedriverecoverysystemnotes, cockpitcontrolsbrakessafetynotes, systemmanagementintegrationnotes, manufacturabilityserviceabilitynotes, aestheticsstylenotes, creativitynotes, miscellaneous, miscellaneousnotes) {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json",
        url: "services/ATA_WebService.asmx/UpdateScoreDesign1E",
        data: theString,
        dataType: "json",
        success: function (response) {
            if (response.hasOwnProperty("d")) { response = response.d; }
...
function WS_deleteRecord_scores_design1E(scoreid) {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json",
        url: "services/ATA_WebService.asmx/DeleteScoreDesign1E",
        data: theString,
        dataType: "json",
        success: function (response) {
            if (response.hasOwnProperty("d")) { response = response.d; }
...
function WS_showRecords_scores_design1E(scoreid) {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json",
        url: "services/ATA_WebService.asmx/GetScoreDesign1E",
        data: theString,
        dataType: "json",
        success: function (response) {
            if (response.hasOwnProperty("d")) { response = response.d; }
...
function WS_insertRecord_scores_design1C3(eventid, carid, scoreid, suspension, framebodyaero, powertrain, cockpitcontrolsbrakessafety, systemmanagementintegration, manufacturabilityserviceability, aestheticsstyle, creativity, carweight, overall, suspensionnotes, framebodyaeronotes, powertrainnotes, cockpitcontrolsbrakessafetynotes, systemmanagementintegrationnotes, manufacturabilityserviceabilitynotes, aestheticsstylenotes, creativitynotes, miscellaneous, miscellaneousnotes) {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json",
        url: "services/ATA_WebService.asmx/InsertScoreDesign1C3",
        data: theString,
        dataType: "json",
        success: function (response) {
            if (response.hasOwnProperty("d")) { response = response.d; }
...
function WS_updateRecord_scores_design1C3(scoreid, suspension, framebodyaero, powertrain, cockpitcontrolsbrakessafety, systemmanagementintegration, manufacturabilityserviceability, aestheticsstyle, creativity, carweight, overall, suspensionnotes, framebodyaeronotes, powertrainnotes, cockpitcontrolsbrakessafetynotes, systemmanagementintegrationnotes, manufacturabilityserviceabilitynotes, aestheticsstylenotes, creativitynotes, miscellaneous, miscellaneousnotes) {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json",
        url: "services/ATA_WebService.asmx/UpdateScoreDesign1C3",
        data: theString,
        dataType: "json",
        success: function (response) {
            if (response.hasOwnProperty("d")) { response = response.d; }
...
function WS_deleteRecord_scores_design1C3(scoreid) {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json",
        url: "services/ATA_WebService.asmx/DeleteScoreDesign1C3",
        data: theString,
        dataType: "json",
        success: function (response) {
            if (response.hasOwnProperty("d")) { response = response.d; }
...
function WS_showRecords_scores_design1C3(scoreid) {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json",
        url: "services/ATA_WebService.asmx/GetScoreDesign1C3",
        data: theString,
        dataType: "json",
        success: function (response) {
            if (response.hasOwnProperty("d")) { response = response.d; }
...
function WS_showRecords_scores_presentation(scoreid) {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json",
        url: "services/ATA_WebService.asmx/GetScorePresentation",
        data: theString,
        dataType: "json",
        success: function (response) {
            if (response.hasOwnProperty("d")) { response = response.d; }
            ...
            if (response != null) {
             ...
             //   scoreP.noveltyNotes						= response.NoveltyNotes;
                ...
                scoreP.finances[7]                      = response.Finances7;
                scoreP.finances[8]                      = response.Finances8;
                scoreP.finances[9]                      = response.Finances9;
                scoreP.finances[10]                     = response.Finances10;
                scoreP.finances[11]                     = response.Finances11;
                ...
                //FDT - ATA2024
                scoreP.demonstration[4]     = response.Demonstration4; 
                scoreP.demonstration[5]     = response.Demonstration5; 
                ...
                scoreP.st2FinConcept[0] = response.St2FinConcept0;
                scoreP.st2FinConcept[1] = response.St2FinConcept1;
                scoreP.st2FinConcept[2] = response.St2FinConcept2;
                scoreP.st2FinConcept[3] = response.St2FinConcept3;
                scoreP.st2FinConcept[4] = response.St2FinConcept4;
                scoreP.st2FinConcept[5] = response.St2FinConcept5;
                scoreP.st2FinConcept[6] = response.St2FinConcept6;
                scoreP.st2FinConcept[7] = response.St2FinConcept7;
                scoreP.st2FinConcept[8] = response.St2FinConcept8;
                scoreP.st2FinConcept[9] = response.St2FinConcept9;                
                scoreP.st2FinConceptNotes = response.St2FinConceptNotes;
	            //FDT - ATA 2023 - aggiunto Financial Concept - FINE

                //FDT - ATA 2023 - aggiunto Financial KPIs & insights - INIZIO
                scoreP.st2FinKPIs[0] = response.St2FinKPIs0;
                scoreP.st2FinKPIs[1] = response.St2FinKPIs1;
                scoreP.st2FinKPIs[2] = response.St2FinKPIs2;
                scoreP.st2FinKPIs[3] = response.St2FinKPIs3;
                scoreP.st2FinKPIs[4] = response.St2FinKPIs4;
                scoreP.st2FinKPIsNotes = response.St2FinKPIsNotes;
...
function WS_insertRecord_scores_presentation(eventid, carid, scoreP) {
    ...
    //FDT - ATA 2023 - eliminato Business Figures - FINE
    //FDT - ATA 2023 - aggiunto Financial Concept - INIZIO
    obj.st2FinConcept = scoreP.st2FinConcept;
    obj.st2FinConceptNotes = scoreP.st2FinConceptNotes;
	//FDT - ATA 2023 - aggiunto Financial Concept - FINE
    //FDT - ATA 2023 - aggiunto Financial KPIs & insights - INIZIO
    obj.st2FinKPIs = scoreP.st2FinKPIs;
    obj.st2FinKPIsNotes = scoreP.st2FinKPIsNotes;
	//FDT - ATA 2023 - aggiunto Financial KPIs & insights - FINE
    //FDT - ATA 2023 - eliminato Content e Investors - INIZIO
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json",
        url: "services/ATA_WebService.asmx/InsertScorePresentation",
        data: theString,
        dataType: "json",
        success: function (response) {
            if (response.hasOwnProperty("d")) { response = response.d; }
...
function WS_updateRecord_scores_presentation(scoreP) {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json",
        url: "services/ATA_WebService.asmx/UpdateScorePresentation",
        data: theString,
        dataType: "json",
        success: function (response) {
            if (response.hasOwnProperty("d")) { response = response.d; }
...
function WS_deleteRecord_scores_presentation(scoreid) {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json",
        url: "services/ATA_WebService.asmx/DeleteScorePresentation",
        data: theString,
        dataType: "json",
        success: function (response) {
            if (response.hasOwnProperty("d")) { response = response.d; }
...
function WS_insertRecord_scores_cost(eventid, carid, scoreid, LowestCost, Accuracy, EventDay, Presentation, Penalties, Notes) {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json",
        url: "services/ATA_WebService.asmx/InsertScoreCost2015",
        data: theString,
        dataType: "json",
        success: function (response) {
            if (response.hasOwnProperty("d")) { response = response.d; }
...
function WS_updateRecord_scores_cost(scoreid, LowestCost, Accuracy, EventDay, Presentation, Penalties, Notes) {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json",
        url: "services/ATA_WebService.asmx/UpdateScoreCost2015",
        data: theString,
        dataType: "json",
        success: function (response) {
            if (response.hasOwnProperty("d")) { response = response.d; }
...
function WS_deleteRecord_scores_cost(scoreid) {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json",
        url: "services/ATA_WebService.asmx/DeleteScoreCost2015",
        data: theString,
        dataType: "json",
        success: function (response) {
            if (response.hasOwnProperty("d")) { response = response.d; }
...
function WS_showRecords_scores_cost(scoreid) {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json",
        url: "services/ATA_WebService.asmx/GetScoreCost2015",
        data: theString,
        dataType: "json",
        success: function (response) {
            if (response.hasOwnProperty("d")) { response = response.d; }
...
function WS_insertRecord_scores_acceleration(eventid, carid, scoreid, r1time, r1numofcones, r2time, r2numofcones, r3time, r3numofcones, r4time, r4numofcones) {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json",
        url: "services/ATA_WebService.asmx/InsertScoreAcceleration",
        data: theString,
        dataType: "json",
        success: function (response) {
            if (response.hasOwnProperty("d")) { response = response.d; }
...
function WS_updateRecord_scores_acceleration(scoreid, r1time, r1numofcones, r2time, r2numofcones, r3time, r3numofcones, r4time, r4numofcones) {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json",
        url: "services/ATA_WebService.asmx/UpdateScoreAcceleration",
        data: theString,
        dataType: "json",
        success: function (response) {
            if (response.hasOwnProperty("d")) { response = response.d; }
...
function WS_deleteRecord_scores_acceleration(scoreid) {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json",
        url: "services/ATA_WebService.asmx/DeleteScoreAcceleration",
        data: theString,
        dataType: "json",
        success: function (response) {
            if (response.hasOwnProperty("d")) { response = response.d; }
...
function WS_showRecords_scores_acceleration(scoreid) {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json",
        url: "services/ATA_WebService.asmx/GetScoreAcceleration",
        data: theString,
        dataType: "json",
        success: function (response) {
            if (response.hasOwnProperty("d")) { response = response.d; }
...
function WS_insertRecord_scores_skidpad(eventid, carid, scoreid, r1time, r1numofcones, r2time, r2numofcones, r3time, r3numofcones, r4time, r4numofcones) {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json",
        url: "services/ATA_WebService.asmx/InsertScoreSkidPad",
        data: theString,
        dataType: "json",
        success: function (response) {
            if (response.hasOwnProperty("d")) { response = response.d; }
...
function WS_updateRecord_scores_skidpad(scoreid, r1time, r1numofcones, r2time, r2numofcones, r3time, r3numofcones, r4time, r4numofcones) {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json",
        url: "services/ATA_WebService.asmx/UpdateScoreSkidPad",
        data: theString,
        dataType: "json",
        success: function (response) {
            if (response.hasOwnProperty("d")) { response = response.d; }
...
function WS_deleteRecord_scores_skidpad(scoreid) {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json",
        url: "services/ATA_WebService.asmx/DeleteScoreSkidPad",
        data: theString,
        dataType: "json",
        success: function (response) {
            if (response.hasOwnProperty("d")) { response = response.d; }
...
function WS_showRecords_scores_skidpad(scoreid) {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json",
        url: "services/ATA_WebService.asmx/GetScoreSkidPad",
        data: theString,
        dataType: "json",
        success: function (response) {
            if (response.hasOwnProperty("d")) { response = response.d; }
...
function WS_insertRecord_scores_autocross(eventid, carid, scoreid, r1time, r1numofcones, r1doc, r2time, r2numofcones, r2doc, r3time, r3numofcones, r3doc, r4time, r4numofcones, r4doc) {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json",
        url: "services/ATA_WebService.asmx/InsertScoreAutoCross",
        data: theString,
        dataType: "json",
        success: function (response) {
            if (response.hasOwnProperty("d")) { response = response.d; }
...
function WS_updateRecord_scores_autocross(scoreid, r1time, r1numofcones, r1doc, r2time, r2numofcones, r2doc, r3time, r3numofcones, r3doc, r4time, r4numofcones, r4doc) {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json",
        url: "services/ATA_WebService.asmx/UpdateScoreAutoCross",
        data: theString,
        dataType: "json",
        success: function (response) {
            if (response.hasOwnProperty("d")) { response = response.d; }
...
function WS_deleteRecord_scores_autocross(scoreid) {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json",
        url: "services/ATA_WebService.asmx/DeleteScoreAutoCross",
        data: theString,
        dataType: "json",
        success: function (response) {
            if (response.hasOwnProperty("d")) { response = response.d; }
...
function WS_showRecords_scores_autocross(scoreid) {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json",
        url: "services/ATA_WebService.asmx/GetScoreAutoCross",
        data: theString,
        dataType: "json",
        success: function (response) {
            if (response.hasOwnProperty("d")) { response = response.d; }
...
function WS_insertRecord_scores_endurance(eventid, carid, scoreid, time, laps, penalities, cones, doc, fuelused, fueltype) {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json",
        url: "services/ATA_WebService.asmx/InsertScoreEndurance",
        data: theString,
        dataType: "json",
        success: function (response) {
            if (response.hasOwnProperty("d")) { response = response.d; }
...
function WS_updateRecord_scores_endurance(scoreid, time, laps, penalities, cones, doc, fuelused, fueltype) {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json",
        url: "services/ATA_WebService.asmx/UpdateScoreEndurance",
        data: theString,
        dataType: "json",
        success: function (response) {
            if (response.hasOwnProperty("d")) { response = response.d; }
...
function WS_deleteRecord_scores_endurance(scoreid) {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json",
        url: "services/ATA_WebService.asmx/DeleteScoreEndurance",
        data: theString,
        dataType: "json",
        success: function (response) {
            if (response.hasOwnProperty("d")) { response = response.d; }
...
function WS_showRecords_scores_endurance(scoreid, carfuelid) {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json",
        url: "services/ATA_WebService.asmx/GetScoreEndurance",
        data: theString,
        dataType: "json",
        success: function (response) {
            if (response.hasOwnProperty("d")) { response = response.d; }
...
function WS_showDetailsEndurance(id) {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json",
        url: "services/ATA_WebService.asmx/GetScoreDetailsEndurance",
        data: theString,
        dataType: "json",
        success: function (response) {
            if (response.hasOwnProperty("d")) { response = response.d; }
...
function WS_set_endurance_settings(totallaps, laplenght, consumptionmax) {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json",
        url: "services/ATA_WebService.asmx/SetEnduranceSettings",
        data: theString,
        dataType: "json",
        success: function (response) {
            if (response.hasOwnProperty("d")) { response = response.d; }
...
function WS_getTotalLapEndurance() {
    $.ajax({
        type: "POST",
        contentType: "application/json",
        url: "services/ATA_WebService.asmx/getTotalLapEndurance",
        data: "",
        dataType: "json",
        success: function (response) {
            if (response.hasOwnProperty("d")) { response = response.d; }
...
function WS_getLapLenghtEndurance() {
    $.ajax({
        type: "POST",
        contentType: "application/json",
        url: "services/ATA_WebService.asmx/getLapLenghtEndurance",
        data: "",
        dataType: "json",
        success: function (response) {
            if (response.hasOwnProperty("d")) { response = response.d; }
...
function WS_getConsumptionMaxEndurance() {
    $.ajax({
        type: "POST",
        contentType: "application/json",
        url: "services/ATA_WebService.asmx/getConsumptionMaxEndurance",
        data: "",
        dataType: "json",
        success: function (response) {
            if (response.hasOwnProperty("d")) { response = response.d; }
...
function WS_ShowPenalties() {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json",
        url: "services/ATA_WebService.asmx/GetPenalties",
        data: "",
        dataType: "json",
        success: function (response) {
            if (response.hasOwnProperty("d")) { response = response.d; }
...
function WS_SavePenalties() {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json",
        url: "services/ATA_WebService.asmx/SavePenalties",
        data: theString,
        dataType: "json",
        success: function (response) {
            if (response.hasOwnProperty("d")) { response = response.d; }
...
function WS_showRecords_scores_presentation_partial(scoresidlist) {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json",
        url: "services/ATA_WebService.asmx/GetScoresPresentationPartials",
        data: theString,
        dataType: "json",
        success: function (response) {
            if (response.hasOwnProperty("d")) { response = response.d; }
            ...
            for (var i = 0; i < partials.length; i++) {
                ...
                //FDT - ATA 2024 - tolta la colonna stage2
...
function WS_showRecords_scores_design1C3_partial(scoresidlist) {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json",
        url: "services/ATA_WebService.asmx/GetScoresDesign1C3Partials",
        data: theString,
        dataType: "json",
        success: function (response) {
            if (response.hasOwnProperty("d")) { response = response.d; }
...
function WS_showRecords_scores_design1E_partial(scoresidlist) {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json",
        url: "services/ATA_WebService.asmx/GetScoresDesign1EPartials",
        data: theString,
        dataType: "json",
        success: function (response) {
            if (response.hasOwnProperty("d")) { response = response.d; }
